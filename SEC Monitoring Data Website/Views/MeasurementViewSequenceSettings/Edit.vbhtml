@ModelType SEC_Monitoring_Data_Website.EditMeasurementViewSequenceSettingViewModel

@Code
    ViewData("Title") = "Edit Measurement View Sequence"
End Code

<h2>Edit Measurement View Sequence</h2>
...
@Using Html.BeginForm()
    ...
    @<fieldset>
        ...
        @Html.HiddenFor(Function(model) model.MeasurementViewSequenceSetting.Id)
         ...
         <table class="edit-table">
             ...
             <tr>
                 ...
                 <td>
                     @Html.DropDownListFor(Function(model) model.DayViewSeriesTypeId,
                                           Model.DayViewSeriesTypeList,
             ...
             <tr>
                 ...
                 <td>
                     @Html.DropDownListFor(Function(model) model.DayViewSeriesDashStyleId,
                                           Model.DayViewSeriesDashStyleList,
             ...
             <tr>
                 ...
                 <td>
                     @Html.DropDownListFor(Function(model) model.WeekViewSeriesTypeId,
                                           Model.WeekViewSeriesTypeList,
             ...
             <tr>
                 ...
                 <td>
                     @Html.DropDownListFor(Function(model) model.WeekViewSeriesDashStyleId,
                                           Model.WeekViewSeriesDashStyleList,
             ...
             <tr>
                 ...
                 <td>
                     @Html.DropDownListFor(Function(model) model.MonthViewSeriesTypeId,
                                           Model.MonthViewSeriesTypeList,
             ...
             <tr>
                 ...
                 <td>
                     @Html.DropDownListFor(Function(model) model.MonthViewSeriesDashStyleId,
                                           Model.MonthViewSeriesDashStyleList,
             ...
             <tr>
                 ...
                 <td>
                     @Html.TextBoxFor(Function(model) model.MeasurementViewSequenceSetting.SeriesColour,
