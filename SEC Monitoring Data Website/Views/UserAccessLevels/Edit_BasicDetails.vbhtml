...
@Html.HiddenFor(Function(model) model.UserAccessLevel.AccessLevelName)
...
<table class="edit-table">
    <tr>
        ...
        <td>
            @Html.DropDownListFor(Function(model) model.ProjectPermissionId, Model.ProjectPermissionList)
        </td>
        <td>
