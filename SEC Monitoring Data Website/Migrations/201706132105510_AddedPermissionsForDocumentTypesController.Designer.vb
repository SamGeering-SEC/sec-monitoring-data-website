...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedPermissionsForDocumentTypesController
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedPermissionsForDocumentTypesController))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706132105510_AddedPermissionsForDocumentTypesController"
            End Get
        End Property
