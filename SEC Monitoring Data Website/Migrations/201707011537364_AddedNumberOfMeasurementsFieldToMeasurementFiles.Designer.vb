...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedNumberOfMeasurementsFieldToMeasurementFiles
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedNumberOfMeasurementsFieldToMeasurementFiles))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201707011537364_AddedNumberOfMeasurementsFieldToMeasurementFiles"
            End Get
        End Property
