...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedPermissionsForMeasurementsController
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedPermissionsForMeasurementsController))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706140032460_AddedPermissionsForMeasurementsController"
            End Get
        End Property
