...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedPermissionsForUserAccessLevelsController
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedPermissionsForUserAccessLevelsController))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706141922299_AddedPermissionsForUserAccessLevelsController"
            End Get
        End Property
