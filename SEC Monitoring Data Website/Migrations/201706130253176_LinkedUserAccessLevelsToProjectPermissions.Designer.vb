...
Namespace Migrations
    ...
    Public NotInheritable Partial Class LinkedUserAccessLevelsToProjectPermissions
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(LinkedUserAccessLevelsToProjectPermissions))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706130253176_LinkedUserAccessLevelsToProjectPermissions"
            End Get
        End Property
