...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedPermissionsForMonitorDeploymentRecords
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedPermissionsForMonitorDeploymentRecords))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706140052091_AddedPermissionsForMonitorDeploymentRecords"
            End Get
        End Property
