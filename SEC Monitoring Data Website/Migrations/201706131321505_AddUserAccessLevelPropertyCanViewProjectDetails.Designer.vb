...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddUserAccessLevelPropertyCanViewProjectDetails
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddUserAccessLevelPropertyCanViewProjectDetails))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706131321505_AddUserAccessLevelPropertyCanViewProjectDetails"
            End Get
        End Property
