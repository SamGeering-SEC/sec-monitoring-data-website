...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedPermissionsForCalculationFiltersController
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedPermissionsForCalculationFiltersController))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706131359018_AddedPermissionsForCalculationFiltersController"
            End Get
        End Property
