...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedPermissionsForOrganisationsController
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedPermissionsForOrganisationsController))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706140236533_AddedPermissionsForOrganisationsController"
            End Get
        End Property
