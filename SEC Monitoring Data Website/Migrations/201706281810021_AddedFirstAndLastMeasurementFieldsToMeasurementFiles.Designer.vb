...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedFirstAndLastMeasurementFieldsToMeasurementFiles
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedFirstAndLastMeasurementFieldsToMeasurementFiles))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706281810021_AddedFirstAndLastMeasurementFieldsToMeasurementFiles"
            End Get
        End Property
