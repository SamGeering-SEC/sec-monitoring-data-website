...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedReceivesLockNotificationsToUserModel
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedReceivesLockNotificationsToUserModel))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201708161016390_AddedReceivesLockNotificationsToUserModel"
            End Get
        End Property
