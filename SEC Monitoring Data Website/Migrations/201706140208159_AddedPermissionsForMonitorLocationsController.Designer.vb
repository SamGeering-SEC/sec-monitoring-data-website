...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedPermissionsForMonitorLocationsController
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedPermissionsForMonitorLocationsController))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706140208159_AddedPermissionsForMonitorLocationsController"
            End Get
        End Property
