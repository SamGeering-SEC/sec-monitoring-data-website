...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedPermissionsForMeasurementCommentTypesController
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedPermissionsForMeasurementCommentTypesController))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706132159509_AddedPermissionsForMeasurementCommentTypesController"
            End Get
        End Property
